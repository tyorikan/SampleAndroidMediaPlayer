package com.test.sampleandroidmediaplayer.utils;
...
public final class DateUtils {
    ...
    public static int durationToInt(String duration) {
        ...
        if (dateStructure.length == 3) {
            sec = sec + (Integer.valueOf(dateStructure[0]) * 3600);
            sec = sec + (Integer.valueOf(dateStructure[1]) * 60);
            sec = sec + Integer.valueOf(dateStructure[2]);

        } else if (dateStructure.length == 2) {
            sec = sec + (Integer.valueOf(dateStructure[0]) * 60);
            sec = sec + Integer.valueOf(dateStructure[1]);
